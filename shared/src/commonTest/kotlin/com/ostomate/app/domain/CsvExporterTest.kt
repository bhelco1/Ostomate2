...
class CsvExporterTest {
    ...
    fun `editedAtMillis column is empty when null`() {
        val csv = CsvExporter.buildCsv(listOf(event(1L, "Bag", SupplyKind.BAG, 1_700_000_000_000L, editedAtMillis = null)))
        val dataRow = csv.trim().lines()[1]
    ...
    fun `editedAtMillis column is present when set`() {
        val csv = CsvExporter.buildCsv(listOf(event(1L, "Bag", SupplyKind.BAG, 1_700_000_000_000L, editedAtMillis = 1_700_000_001_000L)))
